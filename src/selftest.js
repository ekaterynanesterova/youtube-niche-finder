...
// --- хранение вне GitHub ---
{
  ...
  //
  // Проверяем СВОЙСТВА отпечатка, а не то, что лежит в data/. Прежняя
  // проверка требовала там файлов .gz — и упала на раннере, где база
  // поднялась из истории в старом несжатом формате. Проверка, знающая
  // лишнее про окружение, однажды падает не по делу и останавливает прогон.
